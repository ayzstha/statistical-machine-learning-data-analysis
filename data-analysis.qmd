...
Since I am predicting Survived, which is a binary classification problem, my models are set to `"classification"` mode rather than `"regression"`.
...
With this, each model has three versions of preprocessing using KNN, Mean and Median. However, this is looking a bit too messy. To organize everything for my sake and yours, I will arrange this into model lists and workflow sets.
